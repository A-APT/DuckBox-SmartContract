...
contract("BlindSigSecp256k1", function (accounts) {
    let instance = null
    it("is verifySig works well", async function () {
        // get instance first
    ...
    it("is verifySig reverts invalid signature", async function () {
        let m = web3.utils.fromUtf8("0")
    ...
    it("is verifySig with specified PUBKEY works well", async function () {
        let m = web3.utils.fromUtf8("0")
    ...
    it("is verifySig with specified PUBKEY reverts invalid signature", async function () {
        // get instance first
        let m = web3.utils.fromUtf8("0")
